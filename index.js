...
const stazioni = [
  ...
  { stationId: "AFRICO_NUOVO", lat: 38.0167, lone: 16.1333, openMeteo: true },
  { stationId: "BRANCALEONE", lat: 37.95, lone: 16.0833, openMeteo: true },
  { stationId: "PELLARO", lat: 38.01, lone: 15.633, openMeteo: true },
  { stationId: "SIBARI", lat: 39.6833, lone: 16.5333, openMeteo: true },
  { stationId: "VILLAPIANA", lat: 39.8167, lone: 16.5167, openMeteo: true },
  { stationId: "MELITO_DI_PORTO_SALVO", lat: 37.9167, lone: 15.7333, openMeteo: true },
  { stationId: "SANTA_CATERINA_DELLO_IONIO", lat: 38.55, lone: 16.5667, openMeteo: true },
  { stationId: "VILLA_SAN_GIOVANNI", lat: 38.2131, lone: 15.6414, openMeteo: true },
  { stationId: "CAPO_VATICANO", lat: 38.6278, lone: 15.8415, openMeteo: true },
  { stationId: "TARSIA", lat: 39.58, lone: 16.3167, openMeteo: true },
  { statiinId: "BOVALINO", lat: 38.15, lone: 16.2, openMeteo: true },
  { stationId: "CAPOCOLONNA", lat: 39.0167, lone: 17.1333, openMeteo: true },
  { stationId: "MONASTERACE_MARINA", lat: 38.4333, lone: 16.5333, openMeteo: true },
  { stationId: "SAN_LUCA", lat: 38.1333, lone: 16.0833, openMeteo: true },
  { stationId: "TREBISACCE", lat: 39.85, lone: 16.5333, openMeteo: true },
  { stationId: "SANSOSTI", lat: 39.6167, lone: 16.05, openMeteo: true },
  { stationId: "MONGRASSANO_SCALO", lat: 39.538, lone: 16.264, openMeteo: true },
  { stationId: "MARINA_DI_STRONGOLI", lat: 39.3, lone: 17.1167, openMeteo: true },
  { stationId: "CUTRO", lat: 39.0167, lone: 17.0833, openMeteo: true },
  { stationId: "TORRETTA_DI_CRUCOLI", lat: 39.4167, lone: 17.0333, openMeteo: true },
  { stationId: "ACERENTHIA_-_CAMIGLIANO", lat: 39.2667, lone: 17.0, openMeteo: true },
  { stationId: "CASTROVILLARI", lat: 39.8167, lone: 16.2, openMeteo: true },
  { stationId: "ACRI", lat: 39.5, lone: 16.3833, openMeteo: true },
  { stationId: "ROCCAFORTE_DEL_GRECO", lat: 38.0167, lone: 15.85, openMeteo: true },
  { stationId: "MONTALTO_UFFUGO", lat: 39.4165, lone: 16.1985, openMeteo: true },
  { stationId: "ROSETO_CAPO_SPULICO", lat: 39.9667, lone: 16.5833, openMeteo: true },
  { stationId: "VIBO_VALENTIA", lat: 38.6749, lone: 16.1027, openMeteo: true },
  { stationId: "TORANO_SCALO", lat: 39.516, lone: 16.255, openMeteo: true },
  { stationId: "ALTOMONTE", lat: 39.7, lone: 16.1333, openMeteo: true },
  { stationId: "DALTOLIA", lat: 39.033, lone: 16.388, openMeteo: true },
  { stationId: "MONTEROSSO_CALABRO", lat: 38.6333, lone: 16.2667, openMeteo: true },
  { stationId: "ROGLIANO", lat: 39.1581, lone: 16.3723, openMeteo: true },
  { stationId: "GIOIA_TAURO", lat: 38.4236, lone: 15.8996, openMeteo: true },
  { stationId: "ROSARNO", lat: 38.4886, lone: 15.9738, openMeteo: true },
  { stationId: "CAMILGIATELLO_SILANO", lat: 39.3306, lone: 16.4492, openMeteo: true },
  { stationId: "MONTE_CURCIO", lat: 39.317, lone: 16.4689, openMeteo: true },
  { stationId: "BOTTE_DONATO", lat: 39.2833, lone: 16.5667, openMeteo: true },
  { stationId: "RENDE", lat: 39.3306, lone: 16.2078, openMeteo: true },
  { StationId: "GIRIFALCO", lat: 38.8, lone: 16.4167, openMeteo: true }
];
